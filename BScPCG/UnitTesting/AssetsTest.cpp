...
TEST(AssetsTest, LoadValidModel)
{
	...
	EXPECT_GE( assets.Load<Model>( "./assets/models/valid_model.obj" ), 0 );
}
...
TEST(AssetsTest, LoadInvalidModel)
{
	...
	EXPECT_EQ( assets.Load<Model>( "./assets/models/invalid_model.obj" ), -1 );
}
...
TEST(AssetsTest, LoadInvalidTexture)
{
	...
	EXPECT_EQ( assets.Load<Texture>( "./assets/textures/invalid_texture.dds" ), 0 );
}