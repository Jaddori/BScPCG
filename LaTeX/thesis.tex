...
\textbf{Results}: The implementation succeeded with all the technical requirements such as performance and determinism. The user study shows that the cities created are percieved as viable in games. \newline
\textbf{Conclusions}. ...
